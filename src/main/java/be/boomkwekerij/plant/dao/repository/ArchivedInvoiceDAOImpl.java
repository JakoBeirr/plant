...
public class ArchivedInvoiceDAOImpl implements ArchivedInvoiceDAO {

    private final String invoicesDataUri;

    public ArchivedInvoiceDAOImpl() {
        invoicesDataUri = InitializerSingleton.getInitializer().getDataDirectory() + "/archive/invoices/";
    }
