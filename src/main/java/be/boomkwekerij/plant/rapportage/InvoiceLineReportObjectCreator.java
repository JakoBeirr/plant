...
public class InvoiceLineReportObjectCreator {
    ...
    public InvoiceLineReportObject create(InvoiceLineDTO invoiceLineDTO) {
        ...
        invoiceLineReportObject.setPrice(NumberUtils.roundDouble(invoiceLineDTO.getPlantPrice(), 2));
        invoiceLineReportObject.setTotalPrice(NumberUtils.roundDouble(invoiceLineDTO.getTotalPrice(), 2));
